  ...
  module FrontendHelper
    ...
    def breadcrumbs(taxon, separator="&nbsp;")
      ...
      if taxon
        ...
        crumbs << content_tag(:li, content_tag(:span, taxon.name.capitalize), class: 'active', itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
      else
