  ...
  module FrontendHelper
    ...
    def breadcrumbs(taxon, separator="&nbsp;")
      ...
      if taxon
        ...
        crumbs << content_tag(:li, content_tag(:span, link_to(content_tag(:span, taxon.name.capitalize, itemprop: "name") , seo_url(taxon), itemprop: "url"), itemprop: "item"), class: 'active', itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
      else
      ...
      #byebug
      if params[:controller]=="spree/products" && params[:id].present?
        crumbs << content_tag(:li, content_tag(:span, params[:id].capitalize, itemprop: "item"), class: 'active', itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")  
      end
